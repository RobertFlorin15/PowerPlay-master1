...
public class testareAutonom extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(parkingPosition == SleeveDetection.ParkingPosition.LEFT) {
            ...
            encoderDrive(TURN_SPEED, -2.8, 2.6, 4.0);  // S2: Turn Right 12 Inches with 4 Sec timeout\
            encoderDrive(DRIVE_SPEED, 1.25, 1.25, 5);
            ...
            encoderDrive(DRIVE_SPEED, -1.0, -1.0, 5);
            ...
            encoderDrive(TURN_SPEED, 2.0, -2.0, 4);
            encoderDrive(DRIVE_SPEED, 4.75, 4.75, 4.0);
            ...
            encoderDrive(TURN_SPEED, -3.0, 3.0, 4.0);  // S2: Turn Right 12 Inches with 4 Sec timeout\
            encoderDrive(DRIVE_SPEED, 1.95, 1.95, 5);
            ...
            encoderDrive(TURN_SPEED, 0.3, -0.3, 4);
            encoderDrive(DRIVE_SPEED, 3.0, 3.0, 4);
        }
        else {
            sleep(500);
            ...
            encoderDrive(TURN_SPEED, 2.0,-2.0, 4);
            encoderDrive(DRIVE_SPEED, 4.0, 4.0, 4);
        }
