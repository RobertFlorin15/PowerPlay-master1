...
public class SleeveDetection extends OpenCvPipeline {
    ...
    private static Point SLEEVE_TOPLEFT_ANCHOR_POINT = new Point(100, 80);
    ...
    private static final Scalar
            lower_yellow_bounds  = new Scalar(170, 170, 0, 255),
            upper_yellow_bounds  = new Scalar(255, 255, 80, 255),
            lower_cyan_bounds    = new Scalar(0, 100, 150, 255),
            upper_cyan_bounds    = new Scalar(120, 255, 255, 255),
            lower_magenta_bounds = new Scalar(170, 0, 30, 255),
            upper_magenta_bounds = new Scalar(255, 105, 255, 255);
